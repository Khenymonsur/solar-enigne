class AssessmentSessionService:
    ...
    @classmethod
    def save_customer(cls, request, data):
    ...
    @classmethod
    def save_property(cls, request, data):
    ...
    @classmethod
    def appliance_list(cls, request):
    ...
    @classmethod
    def appliance_count(cls, request):

        return len(
            cls.selected_appliances(request)
        )